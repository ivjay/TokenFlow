...
const recentTransactions = [
  { id: 1, date: "2024-02-15 10:30", amount: "0.5 ETH", status: "Confirmed", type: "Sent" },
  { id: 2, date: "2024-02-14 15:45", amount: "100 STC", status: "Pending", type: "Received" },
  { id: 3, date: "2024-02-13 09:15", amount: "0.2 ETH", status: "Failed", type: "Sent" },
]
                      ...
                      {nftReceipts.map((nft) => (
                        <div key={nft.id} className="text-center">
                          <Avatar className="w-20 h-20 mx-auto">
                            <AvatarImage src={nft.image} alt={`NFT ${nft.id}`} />
